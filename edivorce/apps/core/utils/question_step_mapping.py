...
question_step_mapping = {
    ...
    'related_proceedings': ['protection_order_against_you_or_spouse',
                            'protection_order_involving_you_or_spouse',
                            'protection_order_details',
                            'involved_with_child_protective_services',
                            'child_protective_services_details',
                            'criminal_charge_facing',
                            'criminal_charge_court_order',
                            'criminal_charge_demands',
                            'criminal_charge_prison',
...
page_step_mapping = {
    ...
    'proceedings': 'related_proceedings',
